 ...
 */
public class RecipeByStyleAsyncTask extends AsyncTask<Void, Void, ArrayList<String>> {
    ...
    public RecipeByStyleAsyncTask(MainActivity mainActivity, SQLiteDatabase readOnlyDb, String style) {
    ...
    protected ArrayList<String> doInBackground(Void...params) {
        ...
        String selection = RecipeBookContract.Recipes.COLUMN_NAME_STYLE + " =?";
        String[] selectionArgs = {mStyle};
